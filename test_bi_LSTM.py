...
from models.AttnDecoderRNN_LSTM import AttnDecoderRNN as AttnDecoderRNN_bi
from models.EncoderRNN_LSTM import EncoderRNN as EncoderRNN_bi
...
if __name__ == "__main__":
    ...
    bi_enable = True
    if bi_enable:
        encoder1 = EncoderRNN_bi(weights, cfg.EMBEDDING_SIZE, cfg.HIDDEN_SIZE, 1).to(device)
        attn_decoder1 = AttnDecoderRNN_bi(weights, 2 * cfg.HIDDEN_SIZE, 200003, 1).to(device)
    else:
